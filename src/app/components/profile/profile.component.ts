...
export class ProfileComponent implements OnInit {
  ...
  apiUrl = 'https://todo-app-be-e066.onrender.com/api/todos/getuser'; // API endpoint to fetch user details
  delUrl= 'https://todo-app-be-e066.onrender.com/api/todos/deleteuser'
